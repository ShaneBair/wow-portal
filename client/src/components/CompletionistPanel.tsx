...
export function CompletionistPanel() {
  ...
  return (
    <section className="panel award-panel completionist-panel" aria-labelledby="completionistHeading"
      ...
      {leaderboard?.coverage.firstRecordedAt ? <p className="award-scope">
        Recorded quest completions from{" "}<time dateTime={leaderboard.coverage.firstRecordedAt}>
          {formatCoverageTimestamp(leaderboard.coverage.firstRecordedAt)}
        </time>{" "}onward. Repeatable quests count each time.
      </p> : leaderboard ? <p className="award-scope">
        No quest-completion coverage date is available. Repeatable quests count each time.
      </p> : <p className="award-scope">
        Recorded quest completions since quest tracking began. Repeatable quests count each time.
      </p>}
